        ...
        <div className="w-full max-w-7xl mx-auto md:px-8 lg:px-12 md:pt-5 lg:pt-6 md:pb-20">
          ...
          <div className="mx-auto flex w-full max-w-xs flex-col items-center gap-3 md:mx-0 md:w-fit md:max-w-none">
            ...
            <M.a
              ...
              whileTap={{ scale: 0.98 }}
              className="hero-wa-btn__link flex h-full min-h-12 w-full shrink-0 items-center justify-center gap-2.5 rounded-xl px-6 py-3.5 text-xs font-semibold uppercase tracking-widest md:min-h-[3.25rem] md:w-auto md:px-7 md:py-0 md:text-sm md:self-stretch"
