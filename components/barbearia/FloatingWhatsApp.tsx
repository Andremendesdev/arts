...
export default function FloatingWhatsApp() {
  const handleClick = () => {
    const url = getWhatsAppUrl(WHATSAPP_MSG)
  ...
  return (
    <motion.button
      ...
      whileHover={isWhatsAppConfigured ? { scale: 1.1, y: -2 } : undefined}
      whileTap={isWhatsAppConfigured ? { scale: 0.92 } : undefined}
      ...
      onMouseLeave={(e) => {
        ...
        el.style.boxShadow = "0 0 16px rgba(56,189,248,0.35)"
      }}
    >
      <motion.span
