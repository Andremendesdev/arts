...
const reviews = [
  ...
  {
    name: "José Antônio Fernandes",
    text: "Ótimo atendimento. Recomendo!",
  },
  {
    name: "Renato César",
    text: "Esse Barba ruiva não corta, ele faz obra de arte.",
  },
  {
    name: "Gian Rodrigues",
    text: "O cara é o melhor, o atendimento, a simpatia, a comodidade, o semblante do lugar,tudo deixa o ambiente ainda melhor.",
  },
  {
    name: "Deivid Ferrari",
    text: "Melhor Barbearia de Piraju e região.",
  },
];
...
export default function Preview() {
  return (
    <section className="relative overflow-hidden py-24 bg-[#0a0a0a]">
      {/* Glow background */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,234,0,0.05),transparent_60%)]" />
      ...
      <div className="relative z-10 text-center px-5 mb-14">
        ...
        <h2 className="font-serif text-4xl md:text-6xl font-bold tracking-tight">
          O que falam da{" "}
          <span className="text-yellow-400 gold-glow">NA GARAGE</span>
        </h2>
        ...
        >
          {[...reviews, ...reviews].map((review, index) => (
            <div
              ...
              style={{
                boxShadow:
                  "0 0 20px rgba(255,234,0,0.08), inset 0 0 20px rgba(255,234,0,0.03)",
              }}
            >
              {/* Stars */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-5 mt-20">
        ...
        <motion.a
          ...
          style={{
            ...
            boxShadow:
              "0 0 14px rgba(255,234,0,0.25), inset 0 0 14px rgba(255,234,0,0.05)",
